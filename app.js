    ...
    let url = "http://127.0.0.1:5000/";
              ...
              const visualizar = (data) => {
                  ...
                  for (var i = 0; i < data.baul.length; i++) { 
                     ...
                     b+=`<tr><td>${data.baul[i].idbaul}</td><td>${data.baul[i].Plataforma}</td><td>${data.baul[i].usuario}</td><td>${data.baul[i].clave}</td>
                      <td><button type='button' class="btn btn-info" onclick="location.href = 'edit.html?variable1=${data.baul[i].idbaul}'"> <img src='imagenes/edit.png' height ='30' width='30'/></button>
                      <button type='button' class="btn btn-warning" onclick="eliminar(${data.baul[i].idbaul})"> <img src='imagenes/delete.png' height ='30' width='30'/></button></tr>`              
                    }
